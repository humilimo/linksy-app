...
Service Scenario: Checar visualização de mensagem por usuários numa conversa (individual / grupo)
...
Service Scenario: Edição de mensagem numa conversa (individual/grupo)
Given O usuário “lfoc” está cadastrado no sistema
