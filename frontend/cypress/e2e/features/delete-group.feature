Feature: Delete Group
  ...
  Scenario: Dono do Grupo Tenta Deletar Completamente o Grupo Mas Escreve o Nome do Grupo Errado
    Given a conversa de id "1" e de nome "Projeto ESS - Grupo 6" está aparecendo na lista de conversas do usuário de id "1"
    And o usuário de id "1" está na página da conversa de id "1" 
